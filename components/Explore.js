...
const Explore = () => {
  return (
    <div className="bg-white text-blue-900 flex flex-col items-center py-10 space-y-4">
      ...
      <div className="flex justify-center mx-20 gap-10 mt-10"> 
        <div className="border w-[30%] p-4 rounded-md shadow-xl hover:text-white hover:bg-slate-900 hover:scale-105 duration-500 space-y-5">
